                    ...
                    <AnimateSharedLayout>
                        {questions.map(question => (
                            <Question key={question.id} content={question.content} author={question.author} isAnswered={question.isAnswered} isHighlighted={question.isHighlighted}>
                                {!question.isAnswered && (<button className={`like-button ${!!question.likeId && 'liked'}`} type='button' aria-label='Marcar como "gostei"' onClick={() => handleClickLikeButton(question.id, question.likeId)}>
